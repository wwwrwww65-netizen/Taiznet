Config({
    "network-name": "  عبود نت",
    "service-number": "733870140",
    "login-type": "",
    "news-line": "استخدم الإنترنت فيما يرضي الله وتستفيد ولا تجعل الله اهون الناظرين اليك",
    "input-type": "tel",
    ...
    "loan-button": false,
    "redirect-to-est": "",// orWithProtocol: ex, https://google.com leave it blank if dont need mobasher button
